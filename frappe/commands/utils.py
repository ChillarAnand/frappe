...
@click.option('--file', help="Run all tests from the specified file")
...
def run_tests(context, app=None, module=None, doctype=None, test=(), profile=False,
		...
		skip_test_records=False, skip_before_tests=False, failfast=False, file=None):
	...
	with CodeCoverage(coverage, app):
		...
		ret = frappe.test_runner.main(app, module, doctype, context.verbose, tests=tests,
			...
			ui_tests=ui_tests, doctype_list_path=doctype_list_path, failfast=failfast, file=file)
